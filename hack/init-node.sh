...
sudo wget -qO- --show-progress "${CNI_URL}/v0.8.1/cni-plugins-amd64-v0.8.1.tgz" | tar -zx

# download kubelet and kubectl
export KUBE_URL=https://storage.googleapis.com/kubernetes-release/release/v1.15.1/bin/linux/amd64
